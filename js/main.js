...
function countChecked() {
  ...
  var $meterArrow = '#meter__arrow';
  var $countStepArrow = parseInt($checked * 2.25 / $count * 100, 10);
  $($meterArrow).attr('transform', "rotate (".concat($countStepArrow, " 125 111)"));
  $($meterArrow).css('transform', 'rotate(' + $countStepArrow + 'deg)'); // counter number
